...
- [Artefatos P0-2 — 3) `data/backtest/p0_2_status.json`](#3-databacktestp02statusjson)
- [Contrato de Compatibilidade](#contrato-de-compatibilidade)
